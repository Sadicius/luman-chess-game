...
class TestChess:
    def test_initial_board_setup(self, new_game):
        # Test pawns
        for col in range(8):
            assert new_game.get_piece((1, col)) == ('black', 'p')
            assert new_game.get_piece((6, col)) == ('white', 'p')

        # Test other pieces
        piece_order = ['r', 'n', 'b', 'q', 'k', 'b', 'n', 'r']
        
        for col in range(8):
            assert new_game.get_piece((0, col)) == ('black', piece_order[col])
            assert new_game.get_piece((7, col)) == ('white', piece_order[col])

    def test_initial_game_state(self, new_game):
        assert new_game.get_current_player() == 'white'
        assert new_game.get_last_move() is None
    ...
    def test_pawn_moves(self, empty_game):
        ...
        empty_game.set_piece((6, 4), ('white', 'p'))
        empty_game.set_current_player('white')
        ...
        empty_game.set_piece((5, 5), ('black', 'p'))
        moves = empty_game.get_valid_moves((6, 4))
        assert (5, 5) in moves  # Diagonal capture
        
        # Test black pawn moves
        empty_game.set_current_player('black')
        empty_game.set_piece((1, 4), ('black', 'p'))
    ...
    def test_en_passant(self, empty_game):
        ...
        empty_game.set_piece((3, 4), ('white', 'p'))
        empty_game.set_piece((1, 5), ('black', 'p'))
        empty_game.set_current_player('black')
    ...
    def test_king_moves(self, empty_game):
        empty_game.set_piece((4, 4), ('white', 'k'))
        empty_game.set_current_player('white')
        moves = empty_game.get_valid_moves((4, 4))
    ...
    def test_check_detection(self, empty_game):
        ...
        empty_game.set_piece((0, 4), ('white', 'k'))
        empty_game.set_piece((7, 4), ('black', 'r'))
    ...
    def test_checkmate_detection(self, empty_game):
        ...
        empty_game.set_piece((0, 4), ('white', 'k'))
        empty_game.set_piece((7, 4), ('black', 'r'))
        empty_game.set_piece((7, 3), ('black', 'r'))
        empty_game.set_piece((7, 5), ('black', 'r'))
        empty_game.set_current_player('white')
    ...
    def test_stalemate_detection(self, empty_game):
        ...
        empty_game.set_piece((0, 0), ('white', 'k'))
        empty_game.set_piece((2, 1), ('black', 'q'))
        empty_game.set_piece((1, 2), ('black', 'k'))
        empty_game.set_current_player('white')
    ...
    def test_complex_scenario(self, empty_game):
        ...
        for key in piece_setup:
            empty_game.set_piece(key, piece_setup[key])
        empty_game.set_current_player('black')
    ...
    def test_invalid_moves(self, new_game):
        ...
        new_game.set_piece((0, 0), ('white', 'k'))
        new_game.set_piece((1, 0), ('white', 'b'))
        new_game.set_piece((0, 7), ('black', 'r'))
        new_game.set_current_player('white')
